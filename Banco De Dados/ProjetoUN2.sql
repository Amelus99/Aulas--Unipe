...
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(1,1,1);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(2,2,2);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(3,3,3);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(4,4,4);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(5,5,5);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(6,6,6);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(7,7,7);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(8,8,8);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(9,9,9);
insert into  horario_trabalho_funcionario(horario_idhorario, funcionario_idfuncionario,funcao_idfuncao) value(10,10,10);
...
-- consulta nome do filme em br diretor e genero
...
select sala.nome as 'Sala', sala.capacidade, filmes.nomeEN, genero.nome as 'Genero' from sala 
inner join filmes on sala.idSala = filmes.idfilmes
inner join genero on filmes.idfilmes = genero.idgenero
where sala.capacidade > 100; -- 5

select nome, dataContratacao, salario, salario + (salario*17/100)from funcionario; -- 6

create view ultra as 
select f.nome, f.salario, h.horario, u.nome 'funcao' from funcionario f 
inner join horario_trabalho_funcionario t on t.funcionario_idfuncionario = f.idfuncionario
left join funcao u on t.funcao_idfuncao = u.idfuncao
left join horario h on t.horario_idhorario = h.idhorario; -- 7
